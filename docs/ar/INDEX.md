...
**"Smart Traffic"** هي منضدة بحثية وتعليمية تعمل دون اتصال وثنائية اللغة ("RU/EN") تقارن
تقنيتي موقّت — **"NE555"** (نوع "bipolar") و**"К561ТЛ1"** (عبر "CMOS Schmitt trigger") —
بوصفهما نواة توقيت لمتحكم إشارات مرورية مكرر حساس للسلامة: تتابع أطوار "FSM"، و"watchdog"
"relay" تبديل احتياطي، وتوقيت متكيف مع البيئة، ونموذج موثوقية عشوائي، وراسم ذبذبي حي
مع تحليل "jitter". كل ذلك في أربع صفحات "HTML" مستقلة بلا تبعيات ولا خادم ("server").
